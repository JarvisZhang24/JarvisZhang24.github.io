...
export const siteContent: Record<Locale, PageContent> = {
  en: {
    ...
    blog: {
      ...
      empty: "The notebook is ready. Published research notes will appear here soon.",
      homeLead: "Research notes on models, biological data, and the systems behind them.",
      viewAll: "Open blog",
  ...
  zh: {
    ...
    blog: {
      meta: {
        title: "博客 — Yichen Zhang",
        description:
          "关于面向科学发现的生成式人工智能、生物基础模型，以及背后工程实现的记录。",
      },
      title: "博客",
      lead: "关于生成模型、生物数据，以及让它们真正可用所需要的工程细节的记录。",
      empty: "研究笔记已经准备好，公开文章会很快出现在这里。",
      homeLead: "关于模型、生物数据与背后系统实现的研究笔记。",
      viewAll: "进入博客",
      backToIndex: "全部文章",
      minutesLabel: "分钟阅读",
      draftLabel: "草稿",
